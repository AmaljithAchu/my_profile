...
(function($) {
    ...
    Fireworks = function () {
        ...
        self.init = function () {
            ...
            // Function to set canvas width to 100% of container width
            const setCanvasWidthToContainer = function () {
                self.canvas.width = self.cw = self.canvasContainer.width();
            };
        
            // Initial call to set canvas width
            setCanvasWidthToContainer();
        
            // Update canvas width on window resize
            $(window).on('resize', setCanvasWidthToContainer);
        
            self.canvas.height = self.ch = 900; // You might want to adjust this as well
